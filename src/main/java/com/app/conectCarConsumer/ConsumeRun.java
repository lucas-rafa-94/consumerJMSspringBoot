    ...
    public void run() {
        {
            try {
                ...
                Runnable passagemProcessadaConsumer = () -> {
                    jmsConnectionFactory = jmsProperites.get("PassagemProcessadaRemoteConc1020OSA3");
                    consumer.startConnectionFactory("PassagemProcessadaRemoteConc1020OSA3", jmsConnectionFactory, jmsServerConnection);
                };
                Runnable requisitaImagemConsumer = () -> {
                    jmsConnectionFactory = jmsProperites.get("RequisitaImagemRemoteConc1020OSA3");
                    consumer.startConnectionFactory("RequisitaImagemRemoteConc1020OSA3", jmsConnectionFactory, jmsServerConnection);
                };
                Runnable falhaConsumer = () -> {
                    jmsConnectionFactory = jmsProperites.get("FalhaComunicacaoRemoteConc1020OSA3");
                    consumer.startConnectionFactory("FalhaComunicacaoRemoteConc1020OSA3", jmsConnectionFactory, jmsServerConnection);
                };
